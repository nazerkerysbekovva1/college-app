  ...
  return (
    <SafeAreaView className="flex-1 bg-white px-4">
      ...
      <View className="items-center mt-4">
        ...
        <Text className="mt-4 text-lg font-semibold text-gray-800">Приветствую! Чем я могу помочь?</Text>
      </View>
      ...
      <ScrollView className='pt-4 '>
        <View className="space-y-3">
          <TouchableOpacity className="border border-blue-500 p-1 rounded-lg shadow">
            <Text className="text-blue-500 text-center">Топ бойынша расписание</Text>
          </TouchableOpacity>
          <TouchableOpacity className="border border-blue-500 p-1 rounded-lg shadow">
            <Text className="text-blue-500 text-center">Білім бойынша іздеу</Text>
          </TouchableOpacity>
          <TouchableOpacity className="border border-blue-500 p-1 rounded-lg shadow">
            <Text className="text-blue-500 text-center">Оқытушы бойынша</Text>
          </TouchableOpacity>
          <TouchableOpacity className="border border-blue-500 p-1 rounded-lg shadow">
            <Text className="text-blue-500 text-center">Пан бойынша</Text>
          </TouchableOpacity>
          <TouchableOpacity className="border border-blue-500 p-1 rounded-lg shadow">
            <Text className="text-blue-500 text-center">Жалпы расписание</Text>
          </TouchableOpacity>
          <TouchableOpacity className="border border-blue-500 p-1 rounded-lg shadow">
            <Text className="text-blue-500 text-center">Тағы бір нәрсе</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
